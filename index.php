<?php
//Script Author: ᴛɪᴋᴏʟ4ʟɪғᴇ https://t.me/Wab0u
	include 'config.php';
...
<body onload="ccgen();  onLoadChks();"style="background: <?php echo $theme_background ?>;">
	<div class="container" id="container">
		...
		<div class="row justify-content-md-center">
			<div class="col-md">
				<center>
					<img class="rounded-circle" src="<?php echo $site_icon; ?>" width="300" height="300" style="margin-top: 40px;">
				</center>
			</div>
		</div>
		<!-- END OF IMAGE HEADER -->
			...
			<div class="col-md-8">
				<form>
					<div class="form-group">
						...
						<textarea type="text" class="form-control" style="border-color: #32CD32;background: transparent;color: <?php echo $theme_text ?>;overflow:hidden" id="cards" rows="5" placeholder="xxxxxxxxxxxxxxxx|xx|xxxx|xxx" required></textarea>
					</div>
					<div class="form-group">
						<label for="sk" style="color: <?php echo $theme_text ?>; margin-left: 20px"> </label>
						<div class="input-group mb-3 ">
							<select class="form-control" type="text" id="api" style="border-color: #32CD32;background: transparent;color: <?php echo $theme_text ?>;" onchange="showDiv('hidden_div', this)">
								<?php for ($i=0; $i < count($api_file); $i++) {
								echo '<option style="background:'.$theme_background.'" value="'.$api_file[$i].'">'.$api_name[$i].'</option>';
								}?>	
							</select>
							<div class="input-group-append">
								<button class="btn btn-outline-success" type="button" onclick="Settings();">
								...
								<button class="btn btn-success btn-sm btn-block" type="button" onclick="modalCCGEN();">CC Gen</button>
							</div>
						</div>
						
					</div>
					<div class="form-group" id="hidden_div" style="display:none;">
						<label for="sk" style="color: <?php echo $theme_text ?>; margin-left: 20px">Stripe Key</label>
						<div class="input-group mb-3">
							<input type="text" class="form-control" style="border-color: #32CD32;background: transparent;color: <?php echo $theme_text ?>;" id="sk" aria-describedby="sk" placeholder="sk_live_xxxxxxxxxxxxxxxxxx" value="<?php if(isset($_COOKIE['sk_stored'])){echo $_COOKIE['sk_stored'];}?>">
							<div class="input-group-append">
								<button class="btn btn-outline-success" type="button" onclick="copySK();">
								...
								<button class="btn btn-success btn-sm btn-block" type="button" onclick="checkSK();">CHECK SK</button>
							</div>
						</div>
					</div>
					<button style="margin-top: 20px" type="button" class="btn btn-success btn-sm btn-block" onclick="checkCards();">CHECK CARDS</button>
				</form>
			</div>
			<div class="col-md-2"></div>
		</div>
							...
							<div class="col-4">
								...
								<div class="row">
									...
									<div class="col-12 col-sm-8">
										<button type="button" style="margin-top: 10px;" name="clear_cvv" id="clear_cvv" class="btn btn-success btn-sm btn-block" onclick="clearCVV();">Clear CVV</button>
									</div>
								</div>
							</div>
							<div class="col-4">
								...
								<div class="row">
									<div class="col-sm-4"></div>
									<div class="col-12 col-sm-8">
										<button type="button" style="margin-top: 10px;" name="clear_ccn" id="clear_ccn" class="btn btn-success btn-sm btn-block" onclick="clearCCN();">Clear CCN</button>
									</div>
								</div>
							</div>
							<div class="col-4">
		...
		<div class="footer" id="footer"><center><p style="color: <?php echo $theme_text ?>">Wabou</p></center></div>
	</div>
				...
				<div class="modal-body" style="background: <?php echo $theme_background ?>">
					...
					<form name="console" id="console" role="form" method="POST">
						<div>
							<div class="row">
								<div class="col-8 col-lg-8">
									<div class="form-group">
										...
										<input id="ccpN" name="ccp" maxlength="19" type="text" id="inputbin" class="form-control" style="border-color:#32CD32;background: transparent;color: <?php echo $theme_text ?>" placeholder="xxxx xxxx xxxx xxxx">
									</div>
								</div>
								<div class="col-4 col-lg-4">
									<div class="form-group">
										<label class="form-control-label" style="margin-left: 10px;color: <?php echo $theme_text ?>" for="inputcvv">CVV</label>
										<input type="text" id="eccv" name="eccv" style="border-color:#32CD32;background: transparent;color: <?php echo $theme_text ?>" class="form-control" placeholder="rnd" value="rnd">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-4 col-lg-4">
									<div class="form-group">
										...
										<select type="text" class="form-control" style="border-color:#32CD32;background: transparent;color: <?php echo $theme_text ?>" name="emeses">
								...
								<div class="col-4 col-lg-4">
									<div class="form-group">
										...
										<select type="text" class="form-control" style="border-color:#32CD32;background: transparent;color: <?php echo $theme_text ?>" name="eyear">
											<option style="background: <?php echo $theme_background ?>; " value="rnd">RANDOM</option>
								...
								<div class="col-4  col-lg-4">
									<div class="form-group">
										...
										<input type="number" name="ccghm" style="border-color:#32CD32;background: transparent;color: <?php echo $theme_text ?>" maxlength="4" class="form-control" value="10">
							...
							<div class="row">
								<button type="button" style="margin-right: 20px;margin-left: 20px;" class="btn btn-success btn-sm btn-block  name="gerar" id="gerar" onclick="playClick();">GENERATE</button>
							</div>
						</div>
					</form>
				</div>
						...
						<div>
							<div class="row">
								<div class="col-12">
									...
									<div class="input-group mb-3">
										<input name="telebot" type="text" id="telebot" class="form-control" style="border-color:#32CD32;background: transparent;color: <?php echo $theme_text ?>" placeholder="Chat ID" value="<?php if(isset($_COOKIE['chatID_stored'])){echo $_COOKIE['chatID_stored'];}?>">
										<div class="input-group-append">
											<button class="btn btn-outline-success" type="button" onclick="howto();" >
											...
											<button class="btn btn-outline-success" type="button" onclick="testBot();" >
							...
							<div class="row">
								<div class="col-6 col-lg-6">
									...
									<select type="text" class="form-control" style="border-color:#32CD32;background: transparent;color: <?php echo $theme_text ?>" id="tele_msg" >
								...
								<div class="col-6 col-lg-6">
									<div class="form-group">
										...
										<select type="text" class="form-control" style="border-color: #32CD32;background: transparent;color: <?php echo $theme_text ?>" id="delay" >
	...
	<script type="text/javascript">
		function lightmode(){
			setCookie('checker_theme', 'light', '50');
			location.reload();
		}
		function darkmode(){
			setCookie('checker_theme', 'dark', '50');
			location.reload();
		}
