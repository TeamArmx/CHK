...
<body style="background: <?php echo $theme_background ?>;">
	<div class="container" id="container">
		...
		<div class="row justify-content-md-center">
			<div class="col-md">
				<center>
					<img class="rounded-circle" src="<?php echo $site_icon; ?>" width="250" height="250" style="margin-top: 40px;">
				</center>
			</div>
		</div>
		<!-- END OF IMAGE HEADER -->
				...
				<form method="POST">
					<div class="form-group">
						<div class="input-group mb-3 ">
							...
							<input type="text" class="form-control" style="border-color: #32CD32;background: transparent;color: <?php echo $theme_text ?>;" id="authpass" name="authpass" placeholder="Auth Pass">
						</div>
					</div>
					
					<button style="margin-top: 20px" type="submit" name="auth" class="btn btn btn-outline-success btn-block">ACCESS</button>
				</form>
			</div>
			<div class="col-md-4"></div>
		</div>
